...
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Queen","1973-07-13",LOAD_FILE('./images/QueenQueenCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Queen II","1974-03-08",LOAD_FILE('./images/QueenIICover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Sheer Heart Attack","1974-11-08",LOAD_FILE('./images/QueenSheerHeartAttackCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"A Night at the Opera","1975-11-21",LOAD_FILE('./images/QueenANightAtTheOperaCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"A Day at the Races","1976-12-10",LOAD_FILE('./images/QueenADayAtTheRacesCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"News of the World","1977-11-28",LOAD_FILE('./images/QueenNewsOfTheWorldCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Jazz","1978-11-10",LOAD_FILE('./images/QueenJazzCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"The Game","1980-06-30",LOAD_FILE('./images/QueenTheGameCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Flash Gordon","1980-12-08",LOAD_FILE('./images/QueenFlashGordonCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Hot Space","1982-05-04",LOAD_FILE('./images/QueenHotSpaceCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"The Works","1984-02-27",LOAD_FILE('./images/QueenTheWorksCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"A Kind of Magic","1986-06-02",LOAD_FILE('./images/QueenAKindOfMagicCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"The Miracle","1989-05-22",LOAD_FILE('./images/QueenTheMiracleCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Innuendo","1991-02-04",LOAD_FILE('./images/QueenInnuendoCover.png'));

INSERT INTO album (band_id, name, release_date, cover) VALUES
((SELECT b.id FROM band AS b WHERE b.name = 'Queen'),"Made in Heaven","1995-11-06",LOAD_FILE('./images/QueenMadeInHeavenCover.png'));


INSERT INTO music (album_id, name, duration, lyrics) VALUES
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Keep Yourself Alive","00:03:47","I was told a million times
...
Keep you satisfied"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Doing Alright","00:04:09","Yesterday my life was in ruin
...
Doing all right"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Great King Rat","00:05:42","Great king rat died today
 ...
 Would you like to see?"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"My Fairy King","00:04:08","In the land where horses born with eagle wings
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Liar","00:06:23","I have sinned dear father, father, I have sinned
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"The Night Comes Down","00:04:23","When I was young it came to me
...
Now all the world is gray to me
Nobody can see
...
And it''s dark again"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Modern Times Rock 'N Roll","00:01:48","Had to make do with a worn out rock and roll scene
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Son And Daughter","00:03:19","I want you
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Jesus","00:03:44","And then I saw him in the crowd
...
All going down"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen"),
"Seven Seas Of Rhye","00:01:16","Fear me you lords and lady preachers
...
"Procession","00:01:13","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Father To Son","00:06:13","A word in your ear
From father to son
...
Time after time it keeps calling you
Calling you on
...
But my letter to you will stay by your side through the years
...
To son"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"White Queen (As It Began)","00:04:33","So sad her eyes
Smiling dark eyes
So sad her eyes
As it began
...
As it began"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Some Day One Day","00:04:22","You never heard my song before
...
We''ll come home"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"The Loser In The End","00:04:01","Mama''s gotta problem
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Ogre Battle","00:04:08","Now once upon a time
...
Come to ogre battle"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"The Fairy Feller's Master-Stroke","00:02:40","He''s a fairy feller
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Nevermore","00:01:18","There''s no living in my life anymore
...
Nevermore"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"The March Of The Black Queen","00:06:32","Do you mean it?
Do you mean it?
Do you mean it?
...
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Funny How Love Is","00:02:49","Funny how love is everywhere just look and see
...
That''s what love is, that''s what love is"),
((SELECT a.id FROM album AS a WHERE a.name = "Queen II"),
"Seven Seas Of Rhye","00:02:48","Fear me you lords and lady preachers
I descend upon your earth from the skies
I command your very souls you unbelievers
Bring before me what is mine
The seven seas of Rhye
...
"Brighton Rock","00:05:10","Happy little day, Jimmy went away
...
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Killer Queen","00:02:49","She keeps Moët et Chandon
...
You wanna try!"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Tenement Funster","00:02:46","My new purple shoes
...
I''ll make the speed of light outta this place"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Flick Of The Wrist","00:03:17","Dislocate your spine if you don''t sign, he says
...
All this time, honey"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Lily Of The Wrist","00:01:44","I am forever searching high and low
...
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"In The Lap Of The Gods","00:03:22","Ah, ah, ah, ah, ah
Ah, ah, ah
...
Lap of the gods"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Stone Cold Crazy","00:02:13","Sleeping very soundly on a Saturday morning
...
Stone cold crazy, you know!"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Dear Friends","00:01:07","So dear friends
Your love has gone
...
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Misfire","00:01:49","Don''t you misfire
Fill me up
With the desire
To carry on
...
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"Bring Back That Leroy Brown","00:02:15","Bring back, bring back
...
Want him back"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"She Makes Me (StormTrooper in Stilettos)","00:02:09","I love, she makes me
She is my heart
She is my love
She is my love
...
She is my love"),
((SELECT a.id FROM album AS a WHERE a.name = "Sheer Heart Attack"),
"In The Lap Of Gods... Revisited","00:03:46","It''s so easy but I can''t do it
So risky
...
"Death On Two Legs (Deficated To...)","00:03:43","You suck my blood like a leech
...
I feel good"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Lazing On A Sunday Afternoon","00:01:07","I go out to work on Monday morning
...
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"I'm In Love With My Car","00:03:04","The machine of a dream
...
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"You're My Best Friend","00:02:50","Ooh, you make me live
...
(I''m happy, I''m happy at home)
You''re my best friend
Oh, you''re my best friend
Ooh, you make me live
Ooh, you''re my best friend"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"'39","00:03:30","In the year of ''39, assembled here the volunteers
...
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Sweet Lady","00:04:02","You call me up and treat me like a dog
...
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Seaside Redenzvous","00:02:14","Seaside whenever you stroll, along with me
...
Give us a kiss!"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"The Prophet's Song","00:08:20","Oh! Oh! People of the Earth
...
Ah! Aah! Aaah! Aaaah! Aaaaah! Aaaaaaaaah!
...
Laugh at the madman!"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Love Of My Life","00:03:37","Love of my life, you''ve hurt me
...
Ooh, ooh"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Good Company","00:03:23","Take good care of what you''ve got
...
And keep good company"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"Bohemian Rhapsody","00:05:54","Is this the real life?
...
Anyway the wind blows"),
((SELECT a.id FROM album AS a WHERE a.name = "A Night at the Opera"),
"God Save The Queen","00:01:15","God save our gracious queen!
...
"Tie Your Mother Down","00:04:47","Get your party gown
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"You Take My Breath Away","00:05:06","Ooh, ooh, take it take it all away
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"Long Away","00:03:33","You might believe in heaven
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"The Millionaire Waltz","00:04:55","Bring out the charge of the love brigade
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"You And I","00:03:26","Music is playing in the darkness
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"Somebody To Love","00:04:56","Can anybody find me somebody to love?
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"White Man","00:04:58","I'm a simple man with a simple name
...
Oh, yeah"),
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"Good Old-Fashioned Lover Boy","00:02:53","I can dim the lights and sing you songs
Full of sad things
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"Drowse","00:03:43","It's the sad eyed goodbye
...
((SELECT a.id FROM album AS a WHERE a.name = "A Day at the Races"),
"Teo Torriatte (Let Us Cling Together)","00:05:55","When I'm gone
...
"We Will Rock You","00:02:02","Buddy, you're a boy, make a big noise
...
We will, we will rock you"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"We Are The Champtions","00:02:59","I've paid my dues
Time after time
...
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Sheet Heart Attack","00:03:27","Well you're just 17
And all you want to do is disappear
...
I feel so in-ar in-ar in-ar in-ar
In-ar in-ar in-ar in-ar-tic-u-late
...
Sheer heart attack"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"All Dead, All Dead","00:03:09","Memories, memories
...
And gone"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Spread Your Wings","00:04:34","Sammy was low
...
Come on, honey"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Fight From The Inside","00:03:01","Hey, you, boy, hey, you
...
Right down the line"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Get Down, Make Love","00:03:50","Get down, make love
Get down, make love
Get down, make love
Get down, make love
...
Get down, make love"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Sleeping On The Sidewalk","00:03:06","I was nothin' but a city boy
...
(Yeah)"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"Who Needs You","00:03:06","I make it half past six you come at seven
...
Who needs, well I don't need, who needs you?"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"It's Late","00:06:26","You say you love me
...
It's all too late"),
((SELECT a.id FROM album AS a WHERE a.name = "News of the World"),
"My Melancholy Blues","00:03:31","Another party's over
...
Hey!"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Fat Bottomed Girls","00:04:15","Are you gonna take me home tonight?
...
Yes, yes"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Jealousy","00:03:13","Oh, how wrong can you be?
...
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Bicycle race","00:03:00","Bicycle bicycle bicycle
...
I want to ride it where I like"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"If You Can't Beat Them","00:04:15","Keep your chin up when you're feelin' lonely
...
Move on out"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Let Me Entertain You","00:03:01","Let me welcome you ladies and gentlemen
...
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Dead On Time","00:03:23","Fool, always jumping, never happy where you land
...
You're dead!"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"In Only Seven Days","00:02:29","Monday the start of my holiday
...
I'm so sad alone"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Dreamer's Ball","00:03:30","Oh, I used to be your baby
Use to be your pride and joy
...
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Fun It","00:03:28","Everybody in the morning
...
They say that moving your body's right, it's all right
...
Everybody, everybody gonna have a good time tonight
Just shakin' the soles of your feet
Everybody everybody gonna have a good time tonight, time tonight, time tonight
That's the only soul you'll ever meet
...
Don't shun it, fun it"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Leaving Home Ain't Easy","00:03:15","I take a step outside
...
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"Don't Stop Me Now","00:03:29","Tonight, I'm gonna have myself a real good time
I feel alive
...
I don't wanna stop at all"),
((SELECT a.id FROM album AS a WHERE a.name = "Jazz"),
"More Of That Jazz","00:04:16","If you're feeling tired and lonely
...
"Play The Game","00:03:32","Open up your mind and let me step inside
...
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Dragon Attack","00:04:18","Take me to the room where the red's all red
...
From me yeah"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Another One Bites The Dust","00:03:34","Uh, let's go
...
Yeah, alright"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Need Your Loving Tonight","00:02:49","Yeah!
Hey, hey, hey
...
Oh, I need your loving tonight"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Crazy Little Thing Called Love","00:02:43","This thing called love
...
Crazy little thing called love, yeah, yeah"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Rock It (Prime Jive)","00:04:33","When I hear that rock and roll
...
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Don't Try Suicide","00:03:52","A-one, two, three, four, one
Yeah
...
Okay"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Sail Away Sweet Sister","00:03:33","Hey, little babe, you're changing
Babe, are you feeling sore?
Ain't no use in pretending
You don't wanna play no more

It's plain that you aint no baby
...
Yeah, yeah, yeah"),
((SELECT a.id FROM album AS a WHERE a.name = "The Game"),
"Save Me","00:03:49","It started off so well
...
"Flash's Theme","00:03:29","Flash - Ah - Saviour of the universe
...
Flash"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"In The Space Capsule (The Love Theme)","00:02:42","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Ming's Theme (In the Court Of Ming The Merciless)","00:02:40","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"The Ring (Hypnotic Seduction Of Dale)","00:00:57","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Football Fight","00:01:28","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"In The Death Cell (Love Theme Reprise)","00:02:24","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Execution Of Flash","00:01:05","Flash - Ah - Saviour of the universe
Flash - Ah - He'll save ev'ry one of us
Seemingly there is no reason for these
Extraordinary intergalactical upsets (ha ha ha)
...
Flash"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"The Kiss (Aura Resurrects Flash)","00:01:44","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Arboria (Planet Of The Tree Men)","00:01:41","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Escape From The Swamp","00:01:43","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Flash To The Rescue","00:02:43","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Vultan's Theme (Attack Of The Hawk Men)","00:01:12","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Battle Theme","00:02:18","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"The Wedding March","00:00:56","One dance whose steps I never could learn
...
So, I know that you'd hate dancing with me"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Marriage Of Dale And Ming (And Flash Approaching)","00:02:04","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Crash Dive On Mingo City","00:01:00","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"Flash's Theme Reprise","00:01:23","He's for every one of us
...
No-one but the pure in
Heart may find the golden
Grail
Oh, oh, oh, oh
Flash!"),
((SELECT a.id FROM album AS a WHERE a.name = "Flash Gordon"),
"The Hero","00:03:33","So you feel that you ain't nobody
...
"Staying Power","00:04:12","Let me show it to you
See what I got
I got a heel of a lot
Tell me what you feel
Is it real, it is real
...
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Dancer","00:03:50","I'm not invited to the party
...
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Back Chat","00:04:35","Back chat back chat
...
Get on down"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Body Language","00:04:31","Give me, body, give me, body, body
Give me your body
...
Body language body language body language"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Action This Day","00:03:34","This street honey is a mean street
...
Action"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Put Out The Fire","00:03:18","They called him a hero
...
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Life Is Real (Song For Lennon)","00:03:31","Guilt stains on my pillow
...
Life is real"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Calling All Girls","00:03:51","Calling all boys, calling all girls
...
Calling all girls"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Las Palabras De Amor (The Words Of Love)","00:04:31","Don't touch me now
Don't hold me now
...
For evermore"),
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Cool Cat","00:03:29","Ooh, yeah, yeah, yeah, yeah
...
((SELECT a.id FROM album AS a WHERE a.name = "Hot Space"),
"Under Pressure","00:04:08","Pressure, pushing down on me
...
"Radio Ga Ga","00:05:48","I'd sit alone and watch your light
...
Radio"),
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Tear It Up","00:03:24","Are you ready? Well, are you ready?
...
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"It's A Hard Life","00:04:06","I don't want my freedom
...
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Man On The Prowl","00:03:25","I'm gonna take a little walk on the wild side
...
Man on the prowl"),
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Machines (or 'Back To Humans')","00:05:07","It's a machines world
...
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"I Want To Break Free","00:03:18","I want to break free
...
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Keep Passing the Openm Windows","00:05:21","This is the only life for me
...
Just believe, just keep passing the open windows"),
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Hammer To Fall","00:04:25","Here we stand or here we fall
...
((SELECT a.id FROM album AS a WHERE a.name = "The Works"),
"Is This The World We Created...?","00:02:14","Just look at all those hungry mouths we have to feed
...
"One Vision","00:05:11","One man, one goal, one mission
...
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"A Kind Of Magic","00:04:24","It's a kind of magic
...
It's a kind of magic"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"One Year Of Love","00:04:27","Just one year of love
...
And all I can do is surrender"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Pain Is So Close To Pleasure","00:04:21","Ooh, ooh, pain is so close to pleasure oh yeah
...
Pain pleasure"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Friends Will Be Friends","00:04:06","Another red letter day
...
Right till the end"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Who Wants To Live Forever","00:05:15","There's no time for us
...
Forever is our today"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Gimme The Prize","00:04:33","Garage and water from the sprinklers
...
There can be only one"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Don't Lose Your Head","00:04:38","Don't lose your head
...
Don't lose your head"),
((SELECT a.id FROM album AS a WHERE a.name = "A Kind of Magic"),
"Princes Of The Universe","00:03:33","Here we are, born to be kings
...
"Party","00:02:24","We had a good night jamming away
...
Come back, come back
Come back, come back back and play

Hey hey hey
Goodbye, goodbye
Goodbye, goodbye the party is over"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"Khashoggi's Ship","00:02:47","Who said that my party was all over, huh, huh
...
No-one stops my party!"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"The Miracle","00:05:01","Every drop of rain that falls
...
When we can all be friends"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"I Want It All","00:04:40","I want it all
I want it all
I want it all
And I want it now
...
I want it, I want it"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"The Invisible Man","00:03:57","I'm the invisible man
...
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"Breakthru","00:04:08","When love breaks up
...
Breakthru"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"Rain Must Fall","00:04:23","I can see it in your stars
Life is so exciting
Acting so bizarre
...
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"Scandal","00:04:42","Scandal, now you've left me all the world's gonna know
...
Scandal, scandal"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"My baby Does Me","00:03:22","Turn it up a bit, please
...
Does me"),
((SELECT a.id FROM album AS a WHERE a.name = "The Miracle"),
"Was It All Worth It","00:05:47","What is there left for me to do in this life?
...
"Innuendo","00:06:33","One two three four
...
Till the end of time"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"I'm Going Slightly Mad","00:04:22","When the outside temperature rises
...
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"Headlong","00:04:37","And you're rushing headlong, you've got a new goal
...
Headlong"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"I Can't Live With You","00:04:33","I can't live with you
...
I can't live without you"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"Don't Try So Hard","00:03:39","If you're searching out for something
Don't try so hard
...
Don't try so hard"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"Ride The Wild Wind","00:04:42","Ride the wild wind
...
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"All God's People","00:04:21","So all you people give freely
...
We're all God's people"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"These Are The Days Of Our Lives","00:04:15","Sometimes I get to feeling
...
I still love you"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"Delilah","00:03:34","Delilah, Delilah
...
I love your kisses"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"The Hitman","00:04:56","Here we go
...
Oh, hitman, hitman"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"Bijou","00:03:36","You and me we are destined you'll agree
...
My bijou"),
((SELECT a.id FROM album AS a WHERE a.name = "Innuendo"),
"The Show Must Go On","00:04:37","Empty spaces
...
"It's A Beautiful Day","00:02:34","It's a beautiful day
The sun is shining
I feel good
...
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Made In Heaven","00:05:24","I'm taking my ride with destiny
...
Written in the stars"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Let Me Live","00:04:45","Three, four
...
Let me live"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Mother Love","00:04:46","I don't want to sleep with you
...
Mother love"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"My Life Has Been Saved","00:03:15","This is where we are today
...
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"I Was Born To Love You","00:04:49","I was born to love you
...
Yeah, give it to me"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Heaven For Everyone","00:05:36","This could be heaven
...
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Too Much Love Will Kill You","00:0419:","I'm just the pieces of the man I used to be
...
In the end"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"You Don't Fool Me","00:05:24","You don't fool me
You don't fool me
You don't fool me
You don't fool me
You don't fool me
...
You don't fool me"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"A Winter's Tale","00:03:50","It's winter-fall
...
Ooh, it's bliss"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"It's A Beautiful Day (Reprise)","00:03:00","It's a beautiful day
The Sun is shining
I feel good
And no-one's gonna stop me now, oh, yeah
...
I feel good, I feel right
I feel good, I feel right
And no-one, (no-one) no-one's gonna stop me now
...
No-one's (no-one's)"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Yeah","00:00:04","Instrumental"),
((SELECT a.id FROM album AS a WHERE a.name = "Made in Heaven"),
"Untitled","00:22:34","Instrumental");
